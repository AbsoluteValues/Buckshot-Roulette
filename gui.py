...
#배경화면 
wall_image_path = (r"C:\Users\pouyo\Documents\GitHub\Buckshot-Roulette\image\wallpaper.png")
...
#게임 플레이 화면 (게임 보드 판)
board_image_path = (r"C:\Users\pouyo\Documents\GitHub\Buckshot-Roulette\image\game_board.png")
